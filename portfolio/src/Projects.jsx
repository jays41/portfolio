...
const Projects = () => {
  return (
    <section className="section">
        ...
        <ul>
            <p><strong>King’s Capital (King’s Business Club)</strong> - London, Quantitative Trading Associate, October 2024 - Present
                <ul className="subpst">
            ...
            <p><strong>Financial Dashboard with Stock Predictor</strong>
                <ul className="subpst">
